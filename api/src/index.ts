...
app.post("/api/submissions", authMiddleware, async (c) => {
  try {
    ...
    // 验证语言支持
    const supportedLanguages = ['c', 'cpp98', 'cpp11', 'cpp14', 'cpp17', 'cpp20', 'cpp23', 'python3', 'pypy3', 'java8', 'java11', 'java17', 'java21', 'go', 'rust', 'javascript', 'typescript', 'csharp', 'kotlin', 'scala', 'dart', 'php'];
